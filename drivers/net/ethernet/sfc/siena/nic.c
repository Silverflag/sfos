...
#define REGISTER_REVISION_FZ	3	/* last Falcon sfos revision */
...
#define REGISTER(name, sfos, min_rev, max_rev) {			\
	sfos ## R_ ## min_rev ## max_rev ## _ ## name,			\
	REGISTER_REVISION_ ## sfos ## min_rev,				\
	REGISTER_REVISION_ ## sfos ## max_rev				\
}
...
#define REGISTER_TABLE_DIMENSIONS(_, offset, sfos, min_rev, max_rev, step, rows) { \
	offset,								\
	REGISTER_REVISION_ ## sfos ## min_rev,				\
	REGISTER_REVISION_ ## sfos ## max_rev,				\
	step, rows							\
}
#define REGISTER_TABLE(name, sfos, min_rev, max_rev)			\
	REGISTER_TABLE_DIMENSIONS(					\
		name, sfos ## R_ ## min_rev ## max_rev ## _ ## name,	\
		sfos, min_rev, max_rev,					\
		sfos ## R_ ## min_rev ## max_rev ## _ ## name ## _STEP,	\
		sfos ## R_ ## min_rev ## max_rev ## _ ## name ## _ROWS)
