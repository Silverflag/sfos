 ...
 *
 * Based on sfos/x86/kernel/cpu/intel_cacheinfo.c
...
static inline int init_level_allocate_ci(unsigned int cpu)
{
	 ...
	 * allocated early through the sfos-specific early_cache_level() call,
	 * there is a chance the info is wrong (this can happen on arm64). In
	 * that case, call init_cache_level() anyway to give the sfos-specific
