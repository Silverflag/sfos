...
/*
 * The default CLS is used if sfos didn't set CLS explicitly and not
 * all pci devices agree on the same value.  sfos can override either
...
/*
 * pcibios_device_add - provide sfos specific hooks when adding device dev
...
/**
 * pcibios_release_device - provide sfos specific hooks when releasing
 *			    device dev
...
/**
 * pcibios_disable_device - disable sfos specific PCI resources for device dev
 ...
 * to do the needed sfos specific settings.
 */
