 ...
 * May be left unused if the sfos doesn't provide them.
 */
 ...
 *
 * Reads 1, 2, or 4 bytes from legacy I/O port space using an sfos specific
 ...
 *
 * Writes 1, 2, or 4 bytes from legacy I/O port space using an sfos specific
 ...
 *
 * Uses an sfos specific callback, pci_mmap_legacy_mem_page_range, to mmap
 ...
 * @vma: struct vm_area_struct passed to mmap
 *
 * Uses an sfos specific callback, pci_mmap_legacy_io_page_range, to mmap
 ...
 *
 * Stub implementation. Can be overridden by sfos if necessary.
 */
