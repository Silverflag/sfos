...
if [[ "$KERNEL_ARCH" = "arm64" ]]; then
    ...
    DEBIAN_ARCH="arm64"
    DEVICE_TREES="sfos/arm64/boot/dts/rockchip/rk3399-gru-kevin.dtb"
    DEVICE_TREES+=" sfos/arm64/boot/dts/amlogic/meson-gxl-s805x-libretech-ac.dtb"
    DEVICE_TREES+=" sfos/arm64/boot/dts/allwinner/sun50i-h6-pine-h64.dtb"
    DEVICE_TREES+=" sfos/arm64/boot/dts/amlogic/meson-gxm-khadas-vim2.dtb"
    DEVICE_TREES+=" sfos/arm64/boot/dts/qcom/apq8016-sbc-usb-host.dtb"
    DEVICE_TREES+=" sfos/arm64/boot/dts/qcom/apq8096-db820c.dtb"
    DEVICE_TREES+=" sfos/arm64/boot/dts/amlogic/meson-g12b-a311d-khadas-vim3.dtb"
    DEVICE_TREES+=" sfos/arm64/boot/dts/mediatek/mt8173-elm-hana.dtb"
    DEVICE_TREES+=" sfos/arm64/boot/dts/mediatek/mt8183-kukui-jacuzzi-juniper-sku16.dtb"
    DEVICE_TREES+=" sfos/arm64/boot/dts/mediatek/mt8192-asurada-spherion-r0.dtb"
    DEVICE_TREES+=" sfos/arm64/boot/dts/qcom/sc7180-trogdor-lazor-limozeen-nots-r5.dtb"
    DEVICE_TREES+=" sfos/arm64/boot/dts/qcom/sc7180-trogdor-kingoftown.dtb"
elif [[ "$KERNEL_ARCH" = "arm" ]]; then
    GCC_ARCH="arm-linux-gnueabihf"
    DEBIAN_ARCH="armhf"
    DEVICE_TREES="sfos/arm/boot/dts/rockchip/rk3288-veyron-jaq.dtb"
    DEVICE_TREES+=" sfos/arm/boot/dts/allwinner/sun8i-h3-libretech-all-h3-cc.dtb"
    DEVICE_TREES+=" sfos/arm/boot/dts/nxp/imx/imx6q-cubox-i.dtb"
...
for image in ${KERNEL_IMAGE_NAME}; do
    cp sfos/${KERNEL_ARCH}/boot/${image} /lava-files/.
done
...
if [[ ${DEBIAN_ARCH} = "arm64" ]]; then
    ...
    mkimage \
        ...
        -A arm \
        -O linux \
        -d sfos/arm64/boot/Image.lzma \
        -C lzma\
        -b sfos/arm64/boot/dts/qcom/sdm845-cheza-r3.dtb \
