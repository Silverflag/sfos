...
#define ETM_ARCH_MAJOR_VERSION(sfos)	(((sfos) >> 4) & 0xfU)
#define ETM_ARCH_MINOR_VERSION(sfos)	((sfos) & 0xfU)
 ...
 *		   the trace unit.
 * @arch_features: Bitmap of sfos features of etmv4 devices.
 */
...
{
	return drvdata->sfos >= ETM_ARCH_ETE;
}
